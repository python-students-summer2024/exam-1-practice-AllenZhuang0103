...
def bark():
  ...
  """
  name = input("Enter the name of a dog: ")
  age = input("Enter the age of a dog: ")
  breed_of_a_dog = input("Enter the breed of a dog: ")
  name = name.capitalize()
  breed_of_a_dog = breed_of_a_dog.capitalize()
  print(f"{name}, the {age} year old {breed_of_a_dog}, says, \"Woof!\"")
...
def bark_with_validation():
  ...
  age = input("Enter the age of a dog: ")
  breed_of_a_dog = input("Enter the breed of a dog: ").capitalize()
  if len(name) < 2 or not name.isalpha():
    print("Name error!")
  elif not age.isnumeric() or int(age) < 0 or int(age) > 15:
    print("Age error!")
  elif breed_of_a_dog not in ["Schnauzer", "Terrier", "Poodle", "Mastiff"]:
    print("Breed error!")
  else:
    print(f"{name}, the {age} year old {breed_of_a_dog}, says, \"Woof!\"")  
